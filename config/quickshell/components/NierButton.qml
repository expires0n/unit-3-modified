...
Item {
    ...
    property color  fgColor:    Qt.rgba(216/255, 205/255, 245/255, 0.5)
    property color  fgHover:    Qt.rgba(11/255,  10/255,  9/255,  1.0)
    property color  fillColor:  Qt.rgba(216/255, 205/255, 245/255, 1.0)
    property color  borderColor: Qt.rgba(216/255, 205/255, 245/255, 0.18)
