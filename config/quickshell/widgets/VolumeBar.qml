...
ShellRoot {
    ...
    readonly property int hoverWidth: 32
    ...
    readonly property color colFilled: "#A78BFA"
    readonly property color colEmpty:  "#D8CDF5"
    readonly property color colBg:     "#14101D"
                    ...
                    Repeater {
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                color: parent.filled
                                       ? (root.muted ? "#A78BFA" : root.colFilled)
                                       : root.colEmpty
