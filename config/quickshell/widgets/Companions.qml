...
Item {
    ...
    readonly property var companions: [
        ...
        {
            name:  "MAI SHIRANUI", color: "#D8CDF5",
    ...
    Column {
        ...
        Rectangle {
            ...
            width:   parent.width
            height:  86
            color:   Qt.rgba(20/255, 16/255, 29/255, 0.97)
            border.color: root.isReactionBubble ? "#D8CDF5" : Qt.rgba(216/255,205/255,245/255,0.22)
            border.width: 1
            ...
            Column {
                ...
                Text {
                    ...
                    font.family: "SF Mono"; font.pixelSize: 8; font.letterSpacing: 3
                ...
                Text {
                    ...
                    font.family: "SF Mono"; font.pixelSize: 9
                    color:    Qt.rgba(216/255,205/255,245/255,0.65)
        ...
        Row {
            ...
            Rectangle {
                ...
                border.color: Qt.rgba(216/255,205/255,245/255,0.15); border.width: 1
                anchors.verticalCenter: parent.verticalCenter
                Text { anchors.centerIn: parent; text: "‹"; font.pixelSize: 18
                       color: maL.containsMouse ? "#D8CDF5" : Qt.rgba(216/255,205/255,245/255,0.35)
            ...
            Rectangle {
                ...
                anchors.verticalCenter: parent.verticalCenter
                Text { anchors.centerIn: parent; text: "›"; font.pixelSize: 18
                       color: maR.containsMouse ? "#D8CDF5" : Qt.rgba(216/255,205/255,245/255,0.35)
                       Behavior on color { ColorAnimation { duration: 100 } } }
        ...
        Text {
            ...
            text:  root.companions[root.currentIdx].name
            font.family: "SF Mono"; font.pixelSize: 8; font.letterSpacing: 2
            color: root.companions[root.currentIdx].color
        ...
        Row {
            ...
            Repeater {
                ...
                Rectangle {
                    width: 5; height: 5
                    color: index === root.currentIdx ? "#D8CDF5" : Qt.rgba(216/255,205/255,245/255,0.15)
                    Behavior on color { ColorAnimation { duration: 100 } }
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    color: index < recentCount
                        ? (recentCount >= root.spamCount-1 ? "#A78BFA" : "#D8CDF5")
