...
ShellRoot {
    ...
    // ── Palette NieR ──
    readonly property color colCard:     "#A78BFA"
    readonly property color colCardSoft: Qt.rgba(216/255, 205/255, 245/255, 0.4)
    readonly property color colInk:      "#241B38"
    readonly property color colInkSoft:  "#6a604a"
    readonly property color colHi:       "#241B38"
    readonly property color colLight:    "#D8CDF5"
