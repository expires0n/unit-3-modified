        ...
        PanelWindow {
            ...
            Item {
                ...
                Item {
                    ...
                    Column { spacing:2
                        Row { spacing:5
                            Rectangle { width:5;height:5;radius:3;color:"#A78BFA"
                            ...
                            Text{text:"SESSION LOCKED";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                        }
                        Text{text:"NODE · "+root.currentUser+"@arch";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                        Text{text:"セッションロック中";font.family:"Noto Sans JP";font.pixelSize:8;color:"#241B38";opacity:0.7}
                    }
                }
                Item {
                    ...
                    z:5; opacity:parent.uiOp
                    Column { spacing:2
                        Text{text:root.clockFull;font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38";width:200;horizontalAlignment:Text.AlignRight}
                        Text{text:"LONGVIC · FR";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38";width:200;horizontalAlignment:Text.AlignRight}
                    }
                }
                Item {
                    ...
                    z:5; opacity:parent.uiOp
                    Column { spacing:2
                        Text{text:"KERNEL 6.13.2";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                        Text{text:"WM · hyprland";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                    }
                }
                Item {
                    ...
                    z:5; opacity:parent.uiOp
                    Column { spacing:2
                        Text{text:"ARCH LINUX · RX 6700 XT";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38";width:220;horizontalAlignment:Text.AlignRight}
                    }
                }
                ...
                Item {
                    ...
                    Text {
                        ...
                        font.family:"SF Mono";font.pixelSize:8;font.letterSpacing:3;color:"#241B38";y:2
                ...
                Item {
                    ...
                    Rectangle {
                        id: panelRect
                        width:380; color:"#D8CDF5"
                        height: panelCol.implicitHeight + 72
                        border.color:"#241B38"; border.width:1
                        ...
                        Rectangle {
                            ...
                            gradient:Gradient{ orientation:Gradient.Horizontal
                                ...
                                GradientStop{position:0.5;color:"#A78BFA"}
                        ...
                        Rectangle {
                            id:wipeCurtain;anchors.fill:parent;color:"#D8CDF5";z:50
                        ...
                        Column {
                            ...
                            Item { width:parent.width;height:90
                                Rectangle{width:76;height:76;border.color:"#241B38";border.width:1;color:"transparent"
                                    anchors.horizontalCenter:parent.horizontalCenter
                                    Rectangle{width:52;height:52;color:"#241B38";anchors.centerIn:parent
                                        transform:Rotation{angle:45;origin.x:26;origin.y:26}}
                                    Text{text:"NR";font.family:"SF Mono";font.pixelSize:7;color:"#8B7BC7";opacity:0.5;anchors.top:parent.top;anchors.left:parent.left;anchors.margins:3}
                                    Text{text:"2B";font.family:"SF Mono";font.pixelSize:7;color:"#8B7BC7";opacity:0.5;anchors.bottom:parent.bottom;anchors.right:parent.right;anchors.margins:3}
                                }
                            }
                            Text{text:root.currentUser.toUpperCase();font.family:"SF Mono";font.pixelSize:13;font.letterSpacing:3;color:"#241B38";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:4}
                            Text{text:"ユニット · アクティブ";font.family:"Noto Sans JP";font.pixelSize:8;color:"#8B7BC7";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:20}
                            Text{text:root.clockStr;font.family:"SF Mono";font.pixelSize:46;font.letterSpacing:2;color:"#241B38";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:6}
                            Text{text:root.dateStr;font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:3;color:"#8B7BC7";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:20}
                            ...
                            Item { width:parent.width;height:40
                                Rectangle{anchors.fill:parent;color:"transparent"
                                    border.color:inputScope.activeFocus?"#241B38":Qt.rgba(70/255,63/255,46/255,0.22);border.width:1
                                    Behavior on border.color{ColorAnimation{duration:200}}}
                                Text{anchors.left:parent.left;anchors.leftMargin:10;anchors.verticalCenter:parent.verticalCenter;text:"▸";font.pixelSize:10;color:"#A78BFA"}
                                FocusScope {
                                    id:inputScope
                                    ...
                                    TextInput {
                                        ...
                                        font.family:"SF Mono";font.pixelSize:12;font.letterSpacing:2
                                        color:"#241B38";echoMode:TextInput.Password;passwordCharacter:"·"
                                        ...
                                        Text{visible:parent.text==="";anchors.verticalCenter:parent.verticalCenter
                                            text:"parolanı gir...";font.family:"SF Mono";font.pixelSize:11;font.italic:true;color:"#8B7BC7";opacity:0.5}
                                    }
                                }
                            }
                            ...
                            Row{anchors.horizontalCenter:parent.horizontalCenter;spacing:6
                                Repeater{model:6;Rectangle{width:6;height:6;color:"transparent";border.color:"#8B7BC7";border.width:1
                                    Rectangle{visible:index<root.lockInput.length;anchors.fill:parent;color:"#241B38"}}}}
                            Item{width:1;height:6}

                            Text{text:"AUTHENTIFICATION ÉCHOUÉE";font.family:"SF Mono";font.pixelSize:8;font.letterSpacing:2;color:"#A78BFA"
                                anchors.horizontalCenter:parent.horizontalCenter
                            ...
                            Item{width:parent.width;height:42
                                Rectangle{anchors.fill:parent;color:"transparent";border.color:"#241B38";border.width:1}
                                Rectangle{id:unlockFill;anchors.left:parent.left;anchors.top:parent.top;anchors.bottom:parent.bottom;color:"#241B38";width:0
                                    Behavior on width{NumberAnimation{duration:280;easing.type:Easing.InOutQuart}}}
                                Text{anchors.centerIn:parent;text:"Login";font.family:"SF Mono";font.pixelSize:10;font.letterSpacing:3
                                    color:unlockMA.containsMouse?"#D8CDF5":"#241B38";Behavior on color{ColorAnimation{duration:200}}}
