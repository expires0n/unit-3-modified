...
ShellRoot {
    ...
    // ── Appliquer le wallpaper ── seçimi kalıcı dosyaya da yazar (girişte geri gelir)
    function applyWallpaper(idx, monitor) {
        ...
        cmd += "; printf '%s' \"" + file + "\" > ~/.config/hypr/current-wallpaper"
                ...
                Item {
                    ...
                    Column { spacing:2
                        Row { spacing:5
                            ...
                            Text{text:"WALLPAPER SELECT";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                        }
                        Text{text:"NODE · "+root.activeMonitor;font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                    }
                }
                Item {
                    anchors{top:parent.top;right:parent.right;topMargin:28;rightMargin:30}
                    z:5; opacity:parent.uiOp
                    Text{text:root.clockFull;font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                }
                Item {
                    anchors{bottom:parent.bottom;left:parent.left;bottomMargin:28;leftMargin:30}
                    z:5; opacity:parent.uiOp
                    Text{text:"↑↓ / SCROLL  NAVIGATE  ·  ESC  QUIT";font.family:"SF Mono";font.pixelSize:9;font.letterSpacing:2;color:"#241B38"}
                }
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                font.family:"SF Mono";font.pixelSize:10;font.letterSpacing:3
                                color:"#241B38";anchors.horizontalCenter:parent.horizontalCenter
                            }
                            ...
                            Row {
                                ...
                                Item { width:162; height:42
                                    ...
                                    Rectangle { id:fill1;anchors.left:parent.left;anchors.top:parent.top;anchors.bottom:parent.bottom;color:"#241B38";width:0
                                        Behavior on width{NumberAnimation{duration:220}} }
                                    Text { anchors.centerIn:parent
                                        text:"THIS SCREEN"
                                        font.family:"SF Mono";font.pixelSize:10;font.letterSpacing:2
                                        color:ma1.containsMouse?"#D8CDF5":"#241B38"
                                ...
                                Item { width:162; height:42
                                    Rectangle { anchors.fill:parent;color:"transparent";border.color:"#241B38";border.width:1 }
                                    Rectangle { id:fill2;anchors.left:parent.left;anchors.top:parent.top;anchors.bottom:parent.bottom;color:"#241B38";width:0
                                        Behavior on width{NumberAnimation{duration:220}} }
                                    Text { anchors.centerIn:parent
                                        text:"ALL SCREENS"
                                        font.family:"SF Mono";font.pixelSize:10;font.letterSpacing:2
                                        color:ma2.containsMouse?"#D8CDF5":"#241B38"
                                        Behavior on color{ColorAnimation{duration:200}} }
                    ...
                    Repeater {
                        ...
                        Item {
                            ...
                            Rectangle {
                                anchors.fill: parent
                                color: "#14101D"
                                border.color: thumb.absDelta === 0 ? "#D8CDF5" : "#241B38"
