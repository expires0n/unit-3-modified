...
Item {
    ...
    property bool   busy:     false   // seek sürüklenirken gizlenmeyi engeller
    ...
    Item {
        ...
        Item {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    gradient: Gradient {
                        ...
                        GradientStop { position: 0.2; color: Qt.rgba(216/255,205/255,245/255,0.5) }
                        GradientStop { position: 0.8; color: Qt.rgba(216/255,205/255,245/255,0.5) }
                ...
                Item {
                    ...
                    Text {
                        ...
                        color: Qt.rgba(216/255,205/255,245/255,0.2)
                        y: 3
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(216/255,205/255,245/255,0.06)
                    }
                }
                ...
                Item {
                    ...
                    Rectangle {
                        anchors.bottom: parent.bottom
                        width: parent.width; height: 1
                        color: Qt.rgba(216/255,205/255,245/255,0.07)
                    }
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            color: Qt.rgba(216/255,205/255,245/255,0.1)
                        }
                    }
                    ...
                    Item {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                color: Qt.rgba(216/255,205/255,245/255,0.9)
                            ...
                            Text {
                                ...
                                font.pixelSize: 7
                                font.letterSpacing: 1
                                color: Qt.rgba(216/255,205/255,245/255,0.42)
                                elide: Text.ElideRight
                            }
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        border.color: index < 2
                                            ? Qt.rgba(216/255,205/255,245/255,0.3)
                                            : Qt.rgba(216/255,205/255,245/255,0.14)
                                        Text {
                                            id: tagTxt
                                            ...
                                            font.letterSpacing: 1
                                            color: index < 2
                                                ? Qt.rgba(216/255,205/255,245/255,0.6)
                                                : Qt.rgba(216/255,205/255,245/255,0.3)
                                        }
                                    }
                                }
                ...
                Column {
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            font.family: "SF Mono"; font.pixelSize: 7; font.letterSpacing: 1
                            color: Qt.rgba(216/255,205/255,245/255,0.2)
                        }
                        Text {
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            color: Qt.rgba(216/255,205/255,245/255,0.08)
                        }
                        // Fill
                        Rectangle {
                            anchors { verticalCenter: parent.verticalCenter; left: parent.left }
                            height: 2
                            color:  Qt.rgba(216/255,205/255,245/255,0.6)
                        ...
                        Rectangle {
                            ...
                            x:     root.mpLength > 0
                                   ...
                                   : 0
                            width: 1; height: 8
                            color: Qt.rgba(216/255,205/255,245/255,0.8)
                        }

                        MouseArea {
                            anchors { fill: parent; topMargin: -6; bottomMargin: -6 }
                            property bool dragging: false
                            onPressed:  { dragging = true;  root.busy = true;  doSeek(mouseX) }
                            onReleased: { dragging = false; root.busy = false }
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        width: parent.width; height: 1
                        color: Qt.rgba(216/255,205/255,245/255,0.05)
                    }
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                color: root.mpPlaying
                                    ...
                                    : Qt.rgba(216/255,205/255,245/255,0.15)
                            ...
                            Text {
                                ...
                                font.family: "SF Mono"; font.pixelSize: 6; font.letterSpacing: 1
                                color: Qt.rgba(216/255,205/255,245/255,0.15)
                            }
                        }
            ...
            CornerDeco {
                ...
                lineColor: Qt.rgba(216/255,205/255,245/255,0.3)
                size: 18
                z:    5
            }
        }
    ...
    component CBtn: Item {
        ...
        Rectangle {
            ...
            border.color: parent.isPlay
                ? Qt.rgba(216/255,205/255,245/255,0.3)
                : Qt.rgba(216/255,205/255,245/255,0.1)
        ...
        property color textColor: cbMa.containsMouse
            ? "#14101D"
            : (isPlay
                ? Qt.rgba(216/255,205/255,245/255,0.85)
                : Qt.rgba(216/255,205/255,245/255,0.38))
