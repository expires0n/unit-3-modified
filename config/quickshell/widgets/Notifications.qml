...
Scope {
    ...
    component NotifItem: Item {
        ...
        readonly property color accentColor: {
            if (urgency === 2) return "#A78BFA";
            if (urgency === 0) return "#8B7BC7";
            return "#241B38";
        }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                gradient: Gradient {
                    ...
                    GradientStop { position: 0.5; color: "#40A78BFA" }
            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    ctx.strokeStyle = "rgba(36, 27, 56, 0.25)";
                    ctx.lineWidth = 1;
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            anchors.centerIn: parent
                            text: "✕"
                            color: closeMouse.containsMouse ? "#D8CDF5" : "#241B38"
                            font.family: "JetBrains Mono"
                            font.pixelSize: 9
                            Behavior on color { ColorAnimation { duration: 120 } }
                        }
                ...
                RowLayout {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            color: actMouse.containsMouse ? "#241B38" : "transparent"
                            border.color: "#241B38"
                            border.width: 1
                            ...
                            Text {
                                ...
                                color: actMouse.containsMouse ? "#D8CDF5" : "#241B38"
                                font.family: "JetBrains Mono"
                                font.pixelSize: 9
